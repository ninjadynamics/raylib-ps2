...
// EE transforms and matrix products use the verified VU0 kernels. VU0 keeps
// expression order but may differ from EE COP1 in low bits. The startup
// diagnostic retains its ordered EE oracle; other targets keep scalar C.
#if defined(_EE)
